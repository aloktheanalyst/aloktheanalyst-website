// Shared auth-gate helper used by route middleware.
// NOT a Pages Function itself — imported by _middleware.js files.
//
// Usage:
//   import { authGate } from '../_auth-gate.js';
//   export const onRequest = (ctx) => authGate(ctx, { title: '...', subtitle: '...' });

export async function authGate(context, options = {}) {
  const { request, next, env } = context;
  const {
    title = 'Sign in to continue',
    subtitle = 'Access case studies, AI coaching, and analytics practice — free.',
  } = options;
