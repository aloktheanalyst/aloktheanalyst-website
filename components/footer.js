...
(function () {
  ...
  if (!document.getElementById('sfooter-css')) {
    ...
    s.textContent = `
      ...
      #sfooter .sfi-tm { background: #6c47ff; }
      #sfooter .sft-links {
  ...
  const TM = `<svg viewBox="0 0 24 24" fill="currentColor"><path d="M12 2C6.477 2 2 6.477 2 12s4.477 10 10 10 10-4.477 10-10S17.523 2 12 2zm4.5 7h-3v8h-3V9h-3V6h9v3z"/></svg>`;
